...
if (isset($_POST['smtPost'])) {
    ...
    if ($result) {
        header('location:' . URL . 'admin/discussion/manageDiscussion.php?msg=posted');
    }
}
?>
<script>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="center"><input type="submit" name="smtPost" id="smtPost" value="Post" />
                            <input type="button" name="btnCancel" onclick="window.location = 'manageDiscussion.php'" value="Cancel" /></td>
                    </tr>
                </table>
            </form>
        </fieldset>
